...
class Chocante_Product_Archive {
	...
	public static function enqueue_scripts() {
		$shop_js = include get_stylesheet_directory() . '/build/shop-scripts.asset.php';

		wp_enqueue_script(
			'chocante-shop-js',
			get_stylesheet_directory_uri() . '/build/shop-scripts.js',
		...
		$shop_css = include get_stylesheet_directory() . '/build/shop.asset.php';

		wp_enqueue_style(
			'chocante-shop-css',
			get_stylesheet_directory_uri() . '/build/shop.css',
