...
?>
<div class="woocommerce-review-order" id="woocommerce-review-order">
	<div class="woocommerce-review-order__success woocommerce-review-order__notice woocommerce-success" hidden>
		<div class="oocommerce-review-order__notice-body">
			<strong class="woocommerce-review-order__empty-title"><?php esc_html_e( 'Thank you for your reviews', 'woocommerce' ); ?></strong>
			<p class="woocommerce-review-order__empty-body"><?php esc_html_e( 'Your feedback helps other customers make better purchasing decisions.', 'woocommerce' ); ?></p>
		</div>
	</div>
	<header class="woocommerce-review-order__header">
		<h1 class="woocommerce-review-order__title page-title"><?php esc_html_e( 'Review your order', 'woocommerce' ); ?></h1>
	...
	<p class="woocommerce-review-order__meta"><?php echo esc_html( implode( ' · ', $meta_parts ) ); ?></p>
