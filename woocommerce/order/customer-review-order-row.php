...
/**
 * Filter displayed order item name
 *
 * @param string $item_name Order item name.
 * @param int $product_id Item product ID.
 */
$product_name = apply_filters( 'chocante_review_order_item_name', $item->get_name(), $product_id );
...
>
	...
	<div class="woocommerce-review-order__item-rating">
		...
		<p id="<?php echo esc_attr( $rating_label_id ); ?>" class="woocommerce-review-order__item-rating-label form-label">
			<?php
			printf(
